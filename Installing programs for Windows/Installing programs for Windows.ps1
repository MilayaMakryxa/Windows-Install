...
$apps = @(
    ...
    "DuongDieuPhap.ImageGlass" # ImageGlass - программа для просмотра изображений
    "xanderfrangos.twinkletray" # TwinkleTray - программа для регулировки яркости на мониторе (как на MacOS или Linux)
